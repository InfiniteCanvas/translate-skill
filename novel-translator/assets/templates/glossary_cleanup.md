...
- KEEP named entities and named actions: personal names and their aliases, titled positions, places, sects/organizations, techniques and skills, named artifacts, named cultivation realms or power states — plus honorifics and fixed forms of address.
- REMOVE everything that names a class of things instead: common nouns or verbs, everyday words, generic or unnamed objects, pronouns, transient phrases (e.g. 麦穗 "wheat stalks") — delete them even when they recur often or have so far translated consistently.
