...
then tell an agent "fix items 1,4,5 in review-report.md doing what was
suggested".
...
- Command: `review glossary`                 # ... `--fix` when it ran with it
...
## Next steps                               # footer: hand-edit glossary.json (safe,
                                             # re-read every chapter); re-run
                                             # `review glossary` to confirm exit 0;
                                             # `retry --chapters N` for chapters
                                             # already translated with a wrong rendering
````
